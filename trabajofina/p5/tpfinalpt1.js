...
function preload() {
  // CORRECCIÓN IMPORTANTE: Los nombres deben ser exactos al archivo (Mayúsculas importan)
  ...
  pantallas[3] = loadImage('assets/PerderseEnElBosque.png'); // <-- ESTO ARREGLA EL ERROR DE CARGA
...
function draw() {
  ...
  // Verificamos que la imagen exista antes de dibujarla para evitar pantalla negra si algo falla
  ...
  // ... resto de lógica sin cambios drásticos, solo formato ...
  ...
  // Dibujar Flechita en las pantallas correspondientes
    ...
    // Texto extra para la pantalla final (20)
